...
'''
model=mistral 
C:\Users\pathi\.virtualenvs\ice_breaker-8_0o264F\Scripts\python.exe C:\work\udemy-langchain\ice_breaker\Section2-summarize.py 
1. Elon Musk is a billionaire businessman,...

2. Interesting Facts:
   - Elon Musk co-founded PayPal ..
   - In 2022, Musk acquired Twitter for $44 billion and ...
model="llama3.2"
    **Short Summary:**
    Elon Musk is a businessman ... December 2023.
    
    **Two Interesting Facts:**
    1. **Dropped out of ... million.
    2. **Co-founded PayPal ... company.
'''